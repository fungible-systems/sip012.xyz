  ...
  return (
    <Card>
      <Stack spacing={'$extra-loose'} maxWidth={'760px'}>
        ...
        <Text maxWidth="72ch">
          You can use Electrum Wallet to send Bitcoin to the above addresses. This assumes you have an "SP" Stacks address and have stacked independently. If you stacked in a pool, make sure your pool admin votes using the following tutorial. Here's how to do it:
        </Text>
        <Text maxWidth="72ch">
          <br />
          1. Download Electrum Wallet from <Link
            href={
              'https://github.com/bitcoin/bitcoin/blob/6d8543504d8c5bde1d12a3c60407dee44d2c8e11/src/policy/policy.cpp#L16-L29'
            }
          >
          ...
          <br />
          5. Enter your Stacks wallet seed. and change the seed type in options to BIP39
          <br />
          6. Click "Next" and change your wallet type to "legacy" and override the derivation path to (m/44'/5757'/0'), without the brackets.
          <br />
          ...
          <br />
          10. Once you have some Bitcoin on your address, go to the send tab and send 5000 sats to one of the addresses above.
        </Text>
        <Text maxWidth="72ch">
